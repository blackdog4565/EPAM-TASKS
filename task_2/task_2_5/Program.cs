    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (exit != 1)
            {
                ...
                int newY, newD, newM, newExperience;
                string newFirstName, newSecondName, newPatronymic, newPost;
                ...
                int.TryParse(Console.ReadLine(), out newExperience);

                t.Experience = newExperience;
                ...
                Console.Write("\nРаботник создан (\"Опять работа?\")");

                while (choiceAction < 6)
                {
                    Console.WriteLine("\nВыберите действие:\n\t1: Вывести инициалы работника\n\t2: Вывести дату рождения работника\n\t3: Вывести возраст работника\n\t4: Вывести стаж работника\n\t5: Вывести должность\n\t6: Ввести данные нового работника\n\t7: Выйти");
                    ...
                    if (choiceAction > 7 || choiceAction < 1)
        ...
        public string Post
        {
            ...
            set
            {
                if (value.Trim().Length != 0)
                {
                    if (value.Length > 1)
                    {
                        _post = value.Substring(0, 1).ToUpper() + value.Substring(1, value.Length - 1).ToLower();
                    }
                    else
                        _post = value.ToUpper();
        ...
        public int Experience
        {
            ...
            set
            {
                if (value >= 0)
                    ...
                    throw new ArgumentException("Не может быть отрицательного стажа.");
            }
        }
        public void ShowExperience()
        {
            if (Experience == 1)
                Console.WriteLine(Experience + " год");
            else if (Experience >= 2 && Experience <= 4)
                Console.WriteLine(Experience + " года");
            else
                Console.WriteLine(Experience + " лет");
        }
